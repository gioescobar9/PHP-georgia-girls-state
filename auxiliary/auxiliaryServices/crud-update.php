    ...
    <div class="well">
        ...
        <input type = "hidden" name = "studID" id = "studID" value = "<?php echo $id; ?>" />
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="officialPhone" name="phoneNumber" maxlength="15" placeholder="(555)888-0000" name = "officialPhone" value = "<?php echo isset($final['officialPhone']) ? $final['officialPhone']:''; ?>" required><br>
            </div>
            </div>
