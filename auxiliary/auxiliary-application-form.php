    ...
    <div class="well">
        ...
        <input type = "hidden" name = "appID" id = "appID" value = "<?php echo $id; ?>" />
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="address" maxlength="25" placeholder="Unit County" name = "unitCounty" required><br>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" maxlength="15" placeholder="(555)888-0000" 
