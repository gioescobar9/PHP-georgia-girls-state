<?php
            ...
            //query the db to get the students for the specific school
...
<?php
//create a table which displays info about each student that the school has
echo "<div class='container'>";
	echo "<table class = 'table table-striped'>";
		...
		echo "</thead>";
    echo "<tbody>";
//loop through each student and display individual info
for($i = 0;$i<$rows;$i++){
    $result->data_seek($i);
...
if($status == "Complete"){
  ...
  echo "<td><a class = 'btn' href = '../school-application-form.php?id=".$studentID."'><span class='glyphicon glyphicon-pencil'></span>Start Application</a></td>";
 echo "</tr>";
    }
}// end of for loop
